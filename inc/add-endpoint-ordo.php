...
class wp_pharma_classified_add_endpoint {
	 ...
	 * @var string
	 */
	public static $endpoint = 'pharmacy-prescription';
	...
	public function endpoint_content() {
	    echo do_shortcode('[customer_area]');
	}
...
new wp_pharma_classified_add_endpoint();

// Flush rewrite rules on plugin activation.
register_activation_hook( __FILE__, array( 'wp_pharma_classified_add_endpoint', 'install' ) );